<?php 
/** Bloque 5 noticias en portada
------------------------------------------------------------------- */ 
?>
<!-- portada5 -->
<section class="Noticias-bloquePortada5">
	<h2 class="Noticias-categoria">Deportes</h2>
	<section class="Noticias-destacada">
		<?php 
				$id = get_field('bloqueNoticias5', 'option');
				// the query
				$args = array(
						'posts_per_page'	=> 1,
						'cat'				=> $id, 
	...
	<section class="Noticias-secundarias">
		<?php 
				$id2 = get_field('bloqueNoticias5', 'option');
				// the query
				$args = array(
						'posts_per_page'	=> 3,
						'cat'				=> $id2, 
